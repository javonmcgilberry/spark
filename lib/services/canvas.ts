 ...
 *
 * Creates the per-hire private draft channel, its seeded canvas, and
 * handles publish-time syncing (invite hire, publish-state section).
 * Slack canvas endpoints sit outside the narrow SlackClient surface,
 * so they go through ctx.slack.apiCall.
 */
...
// ----- Markdown builders for the draft + published canvas -----
