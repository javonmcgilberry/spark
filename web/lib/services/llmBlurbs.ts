 ...
 *
 * These were methods on LlmService in the Node bot (writePersonBlurb,
 * explainTasks). They're free functions now so the ctx threading is
 * explicit and tests don't need to instantiate a class.
 */
